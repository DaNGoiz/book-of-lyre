...
public class Ferr2DT_TerrainMaterialWindow : EditorWindow
{
    ...
    {
        Ferr2DT_TerrainMaterialWindow window = GetWindow<Ferr2DT_TerrainMaterialWindow>();
    ...
    void OnGUI()
    {
        ...
        if (GUI.changed)
        {
            ...
            Ferr2DT_PathTerrain[] terrain = FindObjectsOfType(typeof(Ferr2DT_PathTerrain)) as Ferr2DT_PathTerrain[];
